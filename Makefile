...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/graphit/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/graphit/lib;)
...
COMBO_PLT = $(HOME)/.graphit_combo_dialyzer_plt
